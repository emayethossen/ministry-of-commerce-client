...
const EmergencyHelpline = () => {
    return (
        <div className="max-w-lg mx-auto my-2 bg-[#EFF6FF] hover:bg-[#FEF2F2] rounded-lg shadow-md">
            <h1 className="text-2xl rounded-lg bg-blue-500 py-4 text-center font-bold text-white">Emergency Hotline</h1>
            <ul className="space-y-4 p-6">
                {helplines.map((helpline, index) => (
                    <li key={index} className="flex items-center justify-between">
                        <div className="flex items-center">
                            <FontAwesomeIcon icon={faPhoneAlt} className="text-blue-500 mr-3" />
